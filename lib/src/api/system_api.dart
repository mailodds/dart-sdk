...
class SystemApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [TelemetrySummary] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TelemetrySummary>> getTelemetrySummary({ 
    String? window = '24h',
    ...
    final _path = r'/v1/telemetry/summary';
    ...
    TelemetrySummary? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(TelemetrySummary),
      ) as TelemetrySummary;
    ...
    return Response<TelemetrySummary>(
      data: _responseData,
  ...
  Future<Response<HealthCheck200Response>> healthCheck({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(HealthCheck200Response),
