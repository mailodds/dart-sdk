...
class DeliverRequest {
  ...
  DeliverRequest({
    ...
    this.campaignType,
    this.structuredData,
    this.schemaData = const {},
    this.autoDetectSchema = false,
    this.aiSummary,
    this.options,
  });
  ...
  bool operator ==(Object other) => identical(this, other) || other is DeliverRequest &&
    ...
    _deepEquality.equals(other.schemaData, schemaData) &&
  ...
  int get hashCode =>
    ...
    (schemaData.hashCode) +
    (autoDetectSchema.hashCode) +
    (aiSummary == null ? 0 : aiSummary!.hashCode) +
    (options == null ? 0 : options!.hashCode);

  @override
  String toString() => 'DeliverRequest[to=$to, from=$from, subject=$subject, html=$html, text=$text, domainId=$domainId, replyTo=$replyTo, headers=$headers, tags=$tags, campaignType=$campaignType, structuredData=$structuredData, schemaData=$schemaData, autoDetectSchema=$autoDetectSchema, aiSummary=$aiSummary, options=$options]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.structuredData != null) {
      ...
      json[r'schema_data'] = this.schemaData;
      json[r'auto_detect_schema'] = this.autoDetectSchema;
    if (this.aiSummary != null) {
      json[r'ai_summary'] = this.aiSummary;
    } else {
      json[r'ai_summary'] = null;
    }
  ...
  static DeliverRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return DeliverRequest(
        ...
        schemaData: mapCastOfType<String, String>(json, r'schema_data') ?? const {},
        autoDetectSchema: mapValueOfType<bool>(json, r'auto_detect_schema') ?? false,
        aiSummary: mapValueOfType<String>(json, r'ai_summary'),
