...
/// Structured data for deliver request. Accepts JSON object, array, or string.
class DeliverRequestStructuredData {
  /// The underlying value.
  final dynamic value;

  /// Returns a new [DeliverRequestStructuredData] instance.
  ...
  /// Returns a new [DeliverRequestStructuredData] instance from the given value.
  // ignore: prefer_constructors_over_static_methods
  static DeliverRequestStructuredData? fromJson(dynamic value) {
    if (value != null) {
      return DeliverRequestStructuredData(value);
    }
    return null;
  }
  ...
  // maps a json object with a list of DeliverRequestStructuredData-objects as value to a dart map
