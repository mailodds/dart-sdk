...
class ListStores200Response {
  ...
  @override
  String toString() => 'ListStores200Response[schemaVersion=$schemaVersion, requestId=$requestId, stores=$stores]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ListStores200Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ListStores200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return ListStores200Response(
        ...
        stores: StoreConnection.listFromJson(json[r'stores']),
      );
    }
    return null;
  }
