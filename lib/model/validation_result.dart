...
class ValidationResult {
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  ValidationResultSuppression? suppression;
  ...
  @override
  String toString() => 'ValidationResult[email=$email, status=$status, subStatus=$subStatus, action=$action, domain=$domain, mxHost=$mxHost, checks=$checks, suppression=$suppression, processedAt=$processedAt]';
  ...
  static ValidationResult? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ValidationResult(
        ...
        checks: mapCastOfType<String, Object>(json, r'checks') ?? const {},
        suppression: ValidationResultSuppression.fromJson(json[r'suppression']),
