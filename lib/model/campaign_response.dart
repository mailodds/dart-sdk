...
class CampaignResponse {
  ...
  @override
  String toString() => 'CampaignResponse[schemaVersion=$schemaVersion, requestId=$requestId, campaign=$campaign, variants=$variants]';
  ...
  static CampaignResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CampaignResponse(
        ...
        campaign: Campaign.fromJson(json[r'campaign']),
        variants: CampaignVariant.listFromJson(json[r'variants']),
      );
    }
    return null;
  }
