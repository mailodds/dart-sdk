...
class PolicyTestResponse {
  ...
  @override
  String toString() => 'PolicyTestResponse[schemaVersion=$schemaVersion, requestId=$requestId, original=$original, modified=$modified, matchedRule=$matchedRule, rulesEvaluated=$rulesEvaluated]';
