...
class DeliverResponse {
  ...
  @override
  String toString() => 'DeliverResponse[schemaVersion=$schemaVersion, requestId=$requestId, messageId=$messageId, status=$status, delivery=$delivery, validation=$validation, contentScan=$contentScan]';
